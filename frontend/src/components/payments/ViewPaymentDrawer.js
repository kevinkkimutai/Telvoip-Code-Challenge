...
import { DocumentArrowDownIcon, EnvelopeIcon, TrashIcon } from '@heroicons/react/24/outline'
import { XMarkIcon } from '@heroicons/react/24/outline'

export default function ViewPaymentDrawer({ isOpen, onClose, payment }) {
  ...
  const handleMarkAsPending = () => {
    console.log('Mark as Pending:', payment.id)
    // TODO: Implement mark as pending functionality
  }

  const handleMarkAsOverdue = () => {
    console.log('Mark as Overdue:', payment.id)
      ...
      >
        <div className="min-h-full p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-xl font-bold text-gray-900">{payment.invoiceNumber || 'N/A'}</p>
          </div>
          ...
          <div className="mb-6">
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-base font-medium text-gray-900">
                {payment.client?.name || payment.clientName || 'N/A'}
              </p>
              {payment.client?.email && (
                <p className="text-sm text-gray-600">{payment.client.email}</p>
              )}
              {payment.client?.company && (
                <p className="text-sm text-gray-600 mt-1">{payment.client.company}</p>
              )}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              ...
              {payment.taxRate && parseFloat(payment.taxRate) > 0 && (
                <div className="flex justify-between">
